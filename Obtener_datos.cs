    ...
    public class Obtener_datos
    {
        ...
        public static void Obtener_id_caja_PorSerial(ref int idcaja)
        {
            ...
            try
            {
                ...
                idcaja = Convert.ToInt32(com.ExecuteScalar());//devuelve el primer dato de la columna
        ...
        public static void mostrarUsuarios(ref DataTable dt)
        {
            ...
            {
                CONEXIONMAESTRA.abrir();
                //MODIFIQUE EL PROCESO PARA SOLO MOSTRAR LOS  ACTIVOS
                SqlDataAdapter da = new SqlDataAdapter("Select * from USUARIO2 where Estado='ACTIVO'", CONEXIONMAESTRA.conectar);
                da.Fill(dt);
                CONEXIONMAESTRA.cerrar();
            }
            catch (Exception ex)
